...
import {
  LayoutDashboard, FolderKanban, CheckSquare, Clock, Users, Settings,
  Monitor, Home, Sparkles, Theater, Lightbulb, ClipboardList, TrendingUp, Package,
} from 'lucide-react';
...
export const STATUS_COLORS: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  pending:     { bg: 'rgba(255, 255, 255, 0.06)', text: 'rgba(255,255,255,0.75)', dot: 'rgba(255,255,255,0.4)' },
  ...
  draft:       { bg: 'rgba(255, 255, 255, 0.06)', text: 'rgba(255,255,255,0.75)', dot: 'rgba(255,255,255,0.4)' },
  ...
  not_started: { bg: 'rgba(255, 255, 255, 0.06)', text: 'rgba(255,255,255,0.75)', dot: 'rgba(255,255,255,0.4)' },
  todo:        { bg: 'rgba(255, 255, 255, 0.06)', text: 'rgba(255,255,255,0.75)', dot: 'rgba(255,255,255,0.4)' },
...
export const INDIAN_CITIES = [
  ...
  'Ahmedabad', 'Jaipur', 'Lucknow', 'Chandigarh', 'Surat', 'Kochi', 'Goa',
  'Indore', 'Nagpur', 'Coimbatore', 'Bhubaneswar', 'Ranchi', 'Vizag',
] as const;
...
export const NAV_ITEMS: Record<string, NavItem[]> = {
  owner: [
    ...
    { icon: Package,         label: 'BOQ',             path: '/boq'    },
...
export const VALIDATION = {
  project_name_min: 3, project_name_max: 100,
  task_title_min: 3,   task_title_max: 200,
  time_entry_max_hours: 24, time_entry_max_travel: 12,
} as const;
...
export const NO_ENTRY_ALERT_HOUR      = 18;

export const ROLE_LABELS: Record<string, string> = {
  owner: 'Owner', team_lead: 'Team Lead', field_staff: 'Field Staff',
  hr: 'HR', project_manager: 'Project Manager',
  procurement_manager: 'Procurement Manager', accounts: 'Accounts', sales: 'Sales',
};
